...
#[derive(Debug)]
pub struct PulseEngineProcessor {
    verbose: bool,
    processed_count: usize,
}

impl PulseEngineProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting PulseEngine processing");
    
    let mut processor = PulseEngineProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = PulseEngineProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = PulseEngineProcessor::new(false);
